...
public static class EndlessDirectiveCatalog
{
    ...
    private static readonly EndlessDirectiveDefinition[] Directives =
    {
        new(
            ...
            "Defeat a surge quota before the next checkpoint to keep the convoy on the redline route.",
        ...
        new(
            ...
            "Salvage Sweep",
            "Reach the next checkpoint with a tight deployment count to secure the richest wreck pockets.",
            "Reward: bank +28 gold, +1 food, and a quick convoy repair.",
            "deploy_limit",
            4,
            0f),
        new(
            ...
            "Hold The Line",
            "Keep the bus hull above the defense threshold until the next checkpoint reaches the safehouse block.",
